...
const Layout = ({ children, title }: LayoutProps) => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-between min-h-screen border-2 border-red ">
        <header>
          <nav className="flex items-center justify-between h-16 px-4 border shadow-md">
            <ToastContainer position="bottom-center" limit={1} />
            <Link href="/">
              <a className="text-2xl font-bold">TanieSuple</a>
            </Link>
            <div>
              <Link href="/cart">
                <a className="p-2">
