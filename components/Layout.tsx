  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-between min-h-screen bg-white ">
        <header>
          <nav className="flex items-center justify-between h-24 px-2 bg-white border-4 shadow-md border-slate-800 xs:px-5">
            <Link href="/">
                  ...
                  <div className="flex items-center p-1 ml-1 border-2 rounded-lg md:p-2">
                    <Menu as="div" className="relative z-20 inline-block ">
                      <Menu.Button className="flex items-center p-1 text-xs text-blue-600 md:text-lg md:p-2">
                        <AiOutlineUser className="p-0 mr-2 text-blue-500 scale-125 " />
                        {session.user.name}{" "}
                      </Menu.Button>
        ...
        <main className="container flex px-4 m-auto mt-4 bg-white">
          {children}
        </main>
